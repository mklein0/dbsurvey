...
Spark Notebook with Parquet docker environment
...
Issue with timestamps in parquet.  Need to store them as INT96 without annotation to see them as timestamps.

https://github.com/dask/fastparquet/issues/93
